# recommendation thats modular -> supported on FLASK Server
...
def recommend_restaurants_for_user(
   ...
   """
   # build the per-user rating DataFrame for the target user
   ...
   # find the top_n most similar users
   ...
   # iterate through those matches until we find some recommendations
